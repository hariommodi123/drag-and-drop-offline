            ...
            >
              <div className="flex items-center w-full h-full min-w-0">
                ...
                <div className="min-w-0 flex-1 overflow-hidden">
                  <p className="text-base font-medium text-gray-600 mb-2 truncate">{stat.name}</p>
                  <p className="text-2xl font-bold text-gray-900 break-words" title={stat.value}>{stat.value}</p>
                </div>
              </div>
            </div>
          );
