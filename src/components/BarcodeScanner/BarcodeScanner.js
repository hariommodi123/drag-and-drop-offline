          ...
          {error ? (
            ...
            <>
              <p className="text-xs sm:text-sm text-gray-600 mb-3 text-center">
                Align the barcode within the frame below. A tone plays when detected.
              </p>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-3 text-xs text-left">
                ...
                <ul className="text-blue-800 space-y-1">
                  ...
                  <li>• Keep lighting bright and even (avoid shadows)</li>
                  <li>• Align the barcode horizontally in the frame</li>
                  <li>• Move slowly until the barcode is sharp</li>
                  <li>• Give the camera a moment to focus</li>
                </ul>
              </div>
              <div className="relative w-full mx-auto overflow-hidden rounded-lg" style={{ maxWidth: '100%', minHeight: '220px' }}>
                <div id="qr-reader" className="w-full h-full bg-gray-100" />
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div className="w-[320px] h-[150px] border-2 border-sky-500/80 bg-sky-500/10 rounded-xl"></div>
                </div>
              </div>
            </>
          )}
