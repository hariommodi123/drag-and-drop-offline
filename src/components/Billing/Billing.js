            ...
            maxLength={10}
                ...
                {customerNameProvided && !billingMobile && (
                  <p className="text-xs text-primary-600 mt-1">
                    {state.currentLanguage === 'hi' 
                      ? '⚠️ ग्राहक का मोबाइल नंबर आवश्यक है'
                      : '⚠️ Customer mobile number is required'}
                  </p>
                )}
                {billingMobile && !isBillingMobileValid && (
                  <p className="text-xs text-red-600 mt-1">
                    {state.currentLanguage === 'hi'
                      ? 'कृपया वैध मोबाइल नंबर दर्ज करें (10 अंक, 6-9 से शुरू)।'
                      : 'Please enter a valid 10-digit mobile number starting with 6-9.'}
                  </p>
                )}
              ...
              <div>
                ...
                {paymentMethod === 'upi' && !sellerUpiId && (
                  <div className="mt-3 rounded-lg border border-primary-200 bg-primary-50 p-4 space-y-3">
                    <div className="text-sm font-semibold text-primary-800">Enable online payments with your UPI ID</div>
                    <p className="text-xs text-primary-700">
                      Save your UPI ID once to accept online payments and auto-fill future bills.
                    </p>
                ...
                {paymentMethod === 'upi' && sellerUpiId && (
                  <div className="mt-2 text-xs text-primary-600">
                    Online payments will use <span className="font-semibold">{sellerUpiId}</span>.
                  </div>
                )}
              </div>
            </div>
